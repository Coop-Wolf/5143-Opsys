...
def WelcomeMessage():
    ...
    print("---------------------------------------------------------------------")
    print(f"To see avaiable commands, type 'commands'.")
    print(f"Type '<command> --help' for information on a specific command.")
    print(f"Type 'exit' or ctrl + c to quit.")
    print(f"Designed and implemented by Tim Haxton, Harika Vemulapalli, and Cooper Wolf.")
    print(f"Don't steal our code, we'll sue.")
